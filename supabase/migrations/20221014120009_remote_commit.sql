...
--
-- Name: activitytype; Type: TYPE; Schema: public; Owner: supabase_admin
--
...
ALTER TYPE "public"."activitytype" OWNER TO "supabase_admin";

--
-- Name: create_profile_user(); Type: FUNCTION; Schema: public; Owner: supabase_admin
--

CREATE FUNCTION "public"."create_profile_user"() RETURNS "trigger"
...
ALTER FUNCTION "public"."create_profile_user"() OWNER TO "supabase_admin";
...
--
-- Name: chats; Type: TABLE; Schema: public; Owner: supabase_admin
--
...
--
-- Name: chats_id_seq; Type: SEQUENCE; Schema: public; Owner: supabase_admin
--
...
--
-- Name: mangaActivities; Type: TABLE; Schema: public; Owner: supabase_admin
--

CREATE TABLE "public"."mangaActivities" (
    "id" "uuid" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"(),
    "filePath" "text",
...
ALTER TABLE "public"."mangaActivities" OWNER TO "supabase_admin";
...
CREATE TABLE "public"."rooms" (
    ...
    "videoActivityID" "uuid",
    "mangaActivityID" "uuid",
...
--
-- Name: videoActivities; Type: TABLE; Schema: public; Owner: supabase_admin
--
...
CREATE TABLE "public"."videoActivities" (
    ...
    "seek" double precision DEFAULT '0'::double precision,
    "lastUpdatedBy" "uuid"
);


ALTER TABLE "public"."videoActivities" OWNER TO "supabase_admin";

--
-- Name: chats chats_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: mangaActivities mangaActivities_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY "public"."mangaActivities"
    ADD CONSTRAINT "mangaActivities_pkey" PRIMARY KEY ("id");
...
--
-- Name: videoActivities videoActivities_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY "public"."videoActivities"
    ADD CONSTRAINT "videoActivities_pkey" PRIMARY KEY ("id");


--
-- Name: chats chats_profileID_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY "public"."chats"
    ADD CONSTRAINT "chats_profileID_fkey" FOREIGN KEY ("profileID") REFERENCES "public"."profiles"("id");
...
--
-- Name: rooms rooms_mangaActivityID_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY "public"."rooms"
    ADD CONSTRAINT "rooms_mangaActivityID_fkey" FOREIGN KEY ("mangaActivityID") REFERENCES "public"."mangaActivities"("id");


--
-- Name: rooms rooms_videoActivityID_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY "public"."rooms"
    ADD CONSTRAINT "rooms_videoActivityID_fkey" FOREIGN KEY ("videoActivityID") REFERENCES "public"."videoActivities"("id");


--
-- Name: videoActivities videoActivities_lastUpdatedBy_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY "public"."videoActivities"
    ADD CONSTRAINT "videoActivities_lastUpdatedBy_fkey" FOREIGN KEY ("lastUpdatedBy") REFERENCES "public"."profiles"("id");


--
-- Name: rooms Enable insert for authenticated users only; Type: POLICY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: videoActivities Enable insert for authenticated users only; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY "Enable insert for authenticated users only" ON "public"."videoActivities" FOR INSERT TO "authenticated" WITH CHECK (true);


--
-- Name: rooms Enable read access for all users; Type: POLICY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: videoActivities Enable read access for all users; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY "Enable read access for all users" ON "public"."videoActivities" FOR SELECT USING (true);
...
--
-- Name: FUNCTION "create_profile_user"(); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION "public"."create_profile_user"() TO "postgres";
GRANT ALL ON FUNCTION "public"."create_profile_user"() TO "anon";
GRANT ALL ON FUNCTION "public"."create_profile_user"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_profile_user"() TO "service_role";
...
--
-- Name: TABLE "chats"; Type: ACL; Schema: public; Owner: supabase_admin
--
...
--
-- Name: SEQUENCE "chats_id_seq"; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON SEQUENCE "public"."chats_id_seq" TO "postgres";
...
--
-- Name: TABLE "mangaActivities"; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON TABLE "public"."mangaActivities" TO "postgres";
GRANT ALL ON TABLE "public"."mangaActivities" TO "anon";
GRANT ALL ON TABLE "public"."mangaActivities" TO "authenticated";
GRANT ALL ON TABLE "public"."mangaActivities" TO "service_role";
...
--
-- Name: TABLE "videoActivities"; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON TABLE "public"."videoActivities" TO "postgres";
GRANT ALL ON TABLE "public"."videoActivities" TO "anon";
GRANT ALL ON TABLE "public"."videoActivities" TO "authenticated";
GRANT ALL ON TABLE "public"."videoActivities" TO "service_role";
